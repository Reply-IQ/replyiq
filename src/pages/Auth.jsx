...
const AUTH_T = {
  en: {
    ...
    subtext: 'AI-drafted responses for every guest review on Google and TripAdvisor. You approve. You post. Professional, fast, on-brand.',
    stat1l: 'response rate', stat2l: 'avg rating lift', stat3l: 'per month',
    bullet1: 'AI-drafted responses for every review. You approve and post in under 60 seconds.',
    bullet2: 'Professional responses. Better rating and more bookings.',
    bullet3: 'Guests who feel heard. 2x more likely to return and recommend you.',
    ...
    trialNote: '1 booking covers your entire monthly cost. No setup fees.',
  ...
  de: {
    ...
    subtext: 'KI-Antwortvorschläge für jede Gästebewertung auf Google und TripAdvisor. Sie prüfen, genehmigen und posten. Professionell und in Ihrer Markenstimme.',
    stat1l: 'Antwortquote', stat2l: 'Ø Bewertungsanstieg', stat3l: 'pro Monat',
    bullet1: 'KI-Entwürfe für jede Bewertung. Sie genehmigen und posten in unter 60 Sekunden.',
    bullet2: 'Professionelle Antworten. Bessere Bewertung und mehr Buchungen.',
    bullet3: 'Gäste, die sich gehört fühlen. 2x häufiger zurückkehrend.',
    ...
    trialNote: '1 Buchung deckt Ihre monatlichen Kosten. Keine Einrichtungsgebuhren.',
  ...
  fr: {
    ...
    subtext: 'Réponses rédigées par IA pour chaque avis sur Google et TripAdvisor. Vous relisez, approuvez et publiez. Professionnel et dans votre style.',
    stat1l: 'taux de réponse', stat2l: 'hausse moy. de note', stat3l: 'par mois',
    bullet1: 'Brouillons IA pour chaque avis. Vous approuvez et publiez en moins de 60 secondes.',
    bullet2: 'Réponses professionnelles. Meilleure note et plus de réservations.',
    bullet3: 'Clients qui se sentent écoutés. 2x plus susceptibles de revenir.',
    ...
    trialNote: '1 reservation couvre votre cout mensuel. Aucun frais de configuration.',
...
function buildProspectEmail(name, hotel, lang) {
  ...
  const copy = {
    en: {
      ...
      why1t: 'Never miss a review again.',
      why1d: 'ReplyIQ drafts a perfect response to every review in your brand voice. You review it, approve it, and post it. Takes under 60 seconds per review.',
      ...
      why3d: 'The average GM spends 2 to 3 hours per week writing review replies. ReplyIQ reduces that to minutes. Permanently.',
      why4t: 'Know exactly where you stand vs competitors',
      why4d: 'Live competitor benchmarking shows every hotel or restaurant within 3km, their rating, their trend and exactly where you stand.',
      ctaTitle: 'Book your 30-minute onboarding call',
      ctaDesc:  'We will set everything up together. Import your reviews, build your AI brand voice, and show you the full dashboard. Takes 10 minutes.',
    ...
    de: {
      ...
      why1t: 'Keine Bewertung mehr unbeantwortet.',
      why1d: 'ReplyIQ erstellt einen perfekten Antwortvorschlag für jede Bewertung in Ihrer Markenstimme. Sie prüfen ihn, genehmigen ihn und posten ihn. Dauert unter 60 Sekunden pro Bewertung.',
      ...
      why4d: 'Live-Konkurrenzanalyse zeigt jeden Betrieb im Umkreis von 3 km, seine Bewertung, seinen Trend und wo Sie stehen.',
      ctaTitle: 'Buchen Sie Ihr 30-minütiges Onboarding-Gespräch',
      ctaDesc:  'Wir richten alles gemeinsam ein. Bewertungen importieren, KI-Markenstimme aufbauen, Dashboard zeigen. Dauert 10 Minuten.',
    ...
    fr: {
      ...
      why1t: 'Plus aucun avis sans réponse.',
      why1d: 'ReplyIQ rédige une réponse parfaite pour chaque avis dans votre voix de marque. Vous la relisez, l\'approuvez et la publiez. Moins de 60 secondes par avis.',
      ...
      why4d: 'Le benchmark concurrentiel en direct montre chaque établissement dans un rayon de 3 km, sa note, sa tendance et votre classement.',
      ctaTitle: 'Réservez votre appel d\'intégration de 30 minutes',
      ctaDesc:  'Nous configurerons tout ensemble. Importer vos avis, construire votre voix de marque IA, vous montrer le tableau de bord complet. 10 minutes.',
  ...
  async function requestAccess(e) {
    ...
    try {
      ...
      await fetch('/api/email', {
        ...
        body: JSON.stringify({
          to: reqEmail,
          subject: lang === 'de' ? 'Ihre ReplyIQ Early-Access-Anfrage: Nachster Schritt' :
                   lang === 'fr' ? 'Votre demande ReplyIQ: prochaine etape' :
