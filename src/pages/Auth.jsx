...
const AUTH_T = {
  en: {
    ...
    subtext: 'Respond to every guest review across Google, TripAdvisor, Booking.com and more. Your AI reputation manager, available 24/7.',
  ...
  de: {
    ...
    subtext: 'Antworten Sie auf jede Gästebewertung auf Google, TripAdvisor, Booking.com und mehr. Ihr KI-Reputationsmanager, rund um die Uhr verfügbar.',
  ...
  fr: {
    ...
    subtext: 'Répondez à chaque avis sur Google, TripAdvisor, Booking.com et plus. Votre gestionnaire de réputation IA, disponible 24h/24.',
...
function buildProspectEmail(name, hotel, lang) {
  ...
  const copy = {
    en: {
      ...
      why1t: 'Respond to every review. No review left unanswered.',
      ...
      why4d: 'Live competitor benchmarking shows every hotel or restaurant within 3km, their rating, their trend, and where you rank.',
    ...
    de: {
      ...
      why1t: 'Auf jede Bewertung antworten. Keine Bewertung bleibt unbeantwortet.',
    ...
    fr: {
      ...
      why1t: 'Répondre à chaque avis. Aucun avis sans réponse.',
